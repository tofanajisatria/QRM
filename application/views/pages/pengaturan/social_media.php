          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url('pengaturanc/proses_data_social_media')?>">
              <div class="box-body ">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input name="pinterest" type="text" class="form-control"  value="<?php echo $row->pinterest; ?>">
                    </div> 
                  </div>
                  <div class="col-md-6">
                    <div class="form-group col-md-12">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('pengaturanc/data_umum')?>" type="button" class="btn btn-warning">Kembali</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
