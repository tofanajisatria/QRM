  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php if (isset($active_form)) { echo $active_form; } ?>">
          <a href="#">
            <i class="fa fa-calendar"></i> <span>Form</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li>
              <a href="<?php echo base_url('formc')?>"><i class="fa fa-circle-o"></i>
                Arsip Dokumen
              </a>
              <a href="<?php echo base_url('kertas_kerjac')?>"><i class="fa fa-circle-o"></i>
                Kertas Kerja
              </a>
            </li>
          </ul>
